...
sum(dati2$year == dati1$year) == sum(
  ...
  sum(
    ...
    dati2$planned_work_days == dati1$planned_work_days &
      dati2$planned_work_days == dati1$PlÄ.notÄ.s.darba.dienas
  ) &
  sum(
    dati2$planned_work_days == dati1$planned_work_days &
      dati2$planned_work_days == dati1$PlÄ.notÄ.s.darba.dienas
  ) == sum(dati2$holidays == dati1$holidays &
             dati2$holidays == dati1$BrÄ.vdienas) &
  sum(dati2$holidays == dati1$holidays &
        dati2$holidays == dati1$BrÄ.vdienas) == sum(
          dati2$vacation_days == dati1$vacation_days &
            dati2$vacation_days == dati1$AtvaÄ.inÄ.juma.dienas
        ) &
  sum(
    dati2$vacation_days == dati1$vacation_days &
      dati2$vacation_days == dati1$AtvaÄ.inÄ.juma.dienas
    ...
    dati2$paid_days_off == dati1$paid_days_off &
      dati2$paid_days_off == dati1$Citas.apmaksÄ.tÄ.s.prombÅ.tnes
  ) &
  sum(
    dati2$paid_days_off == dati1$paid_days_off &
      dati2$paid_days_off == dati1$Citas.apmaksÄ.tÄ.s.prombÅ.tnes
    ...
    dati2$sick_leave_A == dati1$sick_leave_A &
      dati2$sick_leave_A == dati1$SlimÄ.bas.lapas.A.dienas
  ) &
  sum(
    dati2$sick_leave_A == dati1$sick_leave_A &
      dati2$sick_leave_A == dati1$SlimÄ.bas.lapas.A.dienas
    ...
    dati2$sick_leave_B == dati1$sick_leave_B &
      dati2$sick_leave_B == dati1$SlimÄ.bas.lapas.B.dienas
  ) &
  sum(
    dati2$sick_leave_B == dati1$sick_leave_B &
      dati2$sick_leave_B == dati1$SlimÄ.bas.lapas.B.dienas
    ...
    dati2$sick_leave_other == dati1$sick_leave_other &
      dati2$sick_leave_other == dati1$Citas.slimÄ.bas.lapas
  ) &
  sum(
    dati2$sick_leave_other == dati1$sick_leave_other &
      dati2$sick_leave_other == dati1$Citas.slimÄ.bas.lapas
    ...
    dati2$vacation_total == dati1$vacation_total &
      dati2$vacation_total == dati1$KopÄ..atvaÄ.inÄ.jumi
  ) &
  sum(
    dati2$vacation_total == dati1$vacation_total &
      dati2$vacation_total == dati1$KopÄ..atvaÄ.inÄ.jumi
    ...
    dati2$sick_leave_total == dati1$sick_leave_total &
      dati2$sick_leave_total == dati1$KopÄ..slim.lapas
  ) &
  sum(
    dati2$sick_leave_total == dati1$sick_leave_total &
      dati2$sick_leave_total == dati1$KopÄ..slim.lapas
